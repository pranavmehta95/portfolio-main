...
const SkillIcon = ({ skill }) => (
  <div className="flex flex-col items-center gap-2" style={{ width: "60px" }}>
    <Image
      src={`/skills/${skill}.svg`}
      alt={SKILL_NAMES[skill] || skill}
      width={50}
      height={50}
    />
    <span className="text-xs text-gray-light-3 text-center font-mono whitespace-nowrap">
      ...
      <div className="section-container py-16 flex flex-col justify-center">
        ...
        <div className="flex flex-col skills-wrapper">
          ...
          <div className="mt-10">
            ...
            <div className="flex items-start flex-wrap gap-6 staggered-reveal">
